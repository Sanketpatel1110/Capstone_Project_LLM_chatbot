...
const ChatbotPage = ({ darkMode }) => {
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      setMessages([
        ...updatedMessages,
        { sender: "bot", text: "⚠️ Error: Unable to get response." },
      ]);
    }
...
//   return (
//     <>
//       {/* full JSX structure remains unchanged, so you can paste your existing JSX from previous version here */}
//       {/* ensure the API part at the top is used, rest of the file is styling/UI */}
//       <ToastContainer />
//     </>
//   );
// };
